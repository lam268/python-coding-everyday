...
"""
	Description: 
		...
		the song (the number may be zero), after the last word (the number may be zero), 
		...
		modern music, he decided to find out what was the initial song 
...
if __name__ == '__main__':
	s = "WUBJKDWUBWUBWBIRAQKFWUBWUBYEWUBWUBWUBWVWUBWUB"
	print(song_decoder(s))
	# print(' '.join(s.replace('WUB', ' ').strip().split()))